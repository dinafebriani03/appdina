...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'dinafebrii745@gmail.com';//isi dengan email
        $config['smtp_pass'] = 'sxtyhuakqwylgfpq';
        $config['smtp_port'] = '465';
        $config['malltype'] = 'html';
        $config['charset'] = 'utf-8';
        $config['newline'] = "\r\n";
        $this->email->initialize($config);
        $this->email->from('dinafebrii745@gmail.com', 'WEB Programing SMK N 8 Jember');
